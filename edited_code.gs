//Peca edition
// Povezivanje sa docs formom, kako ce izgledati response mail
var EMAIL_TEMPLATE_DOC_URL = 'https://docs.google.com/document/d/1APQlXQ7q6XjNC9i5odFxHnSXE63WfGxh2WX0b6aeoqc/edit?resourcekey=0-87FS2sPTv77FkuleQRnBUg#';
var EMAIL_SUBJECT = 'Vozdra Raja, here is the content you requested';
...
function onFormSubmit(e) {
  ...
  // Dodavanje varijabli za svako polje u formi
  // If the question title is a label, it can be accessed as an object field.
  // If it has spaces or other characters, it can be accessed as a dictionary.
  var timestamp = responses.Timestamp[0];
  var topicsString = responses['How satisfied were you with the event?'][0].trim();
